...
1. [Medium] Add firmware-mode handshake/verification on connect.
...
2. [Medium] Replace “assume default switch mapping” with actual switch-assignment query.
...
3. [Medium] Implement Y/timbre routing end-to-end.
...
4. [Medium] Add integration/e2e coverage for event pipeline in `main.js`.
...
5. [Low] Validate decimation values against firmware constraints and document behavior.
...
6. [Low] Clean up now-legacy NRPN sync helper usage boundary.
