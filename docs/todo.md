...
1. [Medium] Replace “assume default switch mapping” with actual switch-assignment query.
...
2. [Medium] Implement Y/timbre routing end-to-end.
...
3. [Medium] Add integration/e2e coverage for event pipeline in `main.js`.
...
4. [Low] Validate decimation values against firmware constraints and document behavior.
...
5. [Low] Clean up now-legacy NRPN sync helper usage boundary.
